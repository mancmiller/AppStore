...
class AppDetailsCell: UICollectionViewCell {
    ...
    let iconImageView = UIImageView(cornerRadius: 14)
    ...
    let releaseNotesLabel = UILabel(text: "Release Notes", numberOfLines: 0, font: .systemFont(ofSize: 16), textColor: .label)
